...
using IntermediateProcessCubeProjekt.Worker.Example;
using IntermediateProcessCubeProjekt.Worker.RandomNumber;
...
builder.Services.AddScoped<RandomNumberHandler>();
